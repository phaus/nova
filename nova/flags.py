...
DEFINE_list('enabled_apis',
            ['ec2', 'osapi_compute', 'osapi_volume', 'metadata', 'occiapi'],
...
DEFINE_integer('occiapi_listen_port', 8787, 'OCCI API port')
DEFINE_string('occiapi_host', '0.0.0.0', 'OCCI API server')
