...
class Image(object):
    ...
    def ensure_created(self):
        ...
        if not self.check_image_exists_locally():
            ...
            images.fetch_to_raw(self.context, self.image_uuid, self.image_temp_target, self.user_id, self.tenant_id)
            self.register_image()

    def check_image_exists_locally(self):
        # TODO: make this more robust (imgadm show..) but imgadm has to work then...
